...
from .models import *
from django.views.generic import(TemplateView ,DetailView, DeleteView , ListView, FormView, CreateView, UpdateView)
from .forms import *
...
class LessonDetailView(DetailView, FormView):
    ...
    # seeing and checking whether the text entered is A Comment or A Reply
    ...
    # getting the post req from the person entering comment/reply.
    ...
    # defining the valid form functions 
